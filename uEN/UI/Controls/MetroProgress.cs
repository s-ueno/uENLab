...
{
    public class MetroProgress : ProgressBar
    {
        
        public static readonly DependencyProperty EllipseDiameterProperty =
            DependencyProperty.Register("EllipseDiameter", typeof(double), typeof(MetroProgress),
                                        new PropertyMetadata(default(double)));

        public static readonly DependencyProperty EllipseOffsetProperty =
            DependencyProperty.Register("EllipseOffset", typeof(double), typeof(MetroProgress),
                                        new PropertyMetadata(default(double)));

        private Storyboard indeterminateStoryboard;

        static MetroProgress()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(MetroProgress), new FrameworkPropertyMetadata(typeof(MetroProgress)));
            IsIndeterminateProperty.OverrideMetadata(typeof(MetroProgress), new FrameworkPropertyMetadata(OnIsIndeterminateChanged));
        }
        ...
        {
            var bar = dependencyObject as MetroProgress;
